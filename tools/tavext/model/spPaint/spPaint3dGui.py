...
class spPaint3dWin (object):
    ...
    def __init__(self):
        ...
        self.uiSourceBtnAdd = mc.symbolButton(w=60, h=18, ann='Add selected object(s) to the list', image=retimg('sp3dadd.xpm'), command=lambda * args:self.uiListCallback("add", "uiSourceList"))
        self.uiSourceBtnRem = mc.symbolButton(w=60, h=18, ann='Remove selected object(s) from the list', image=retimg('sp3drem.xpm'), command=lambda * args:self.uiListCallback("rem", "uiSourceList"))
        self.uiSourceBtnClr = mc.symbolButton(w=60, h=18, ann='Clear the list', image=retimg('sp3dclr.xpm'), command=lambda * args:self.uiListCallback("clr", "uiSourceList"))
        ...
        self.uiTargetBtnAdd = mc.symbolButton(w=60, h=18, ann='Add selected object(s) to the list', image=retimg('sp3dadd.xpm'), command=lambda * args:self.uiListCallback("add", "uiTargetList"))
        self.uiTargetBtnRem = mc.symbolButton(w=60, h=18, ann='Remove selected object(s) from the list', image=retimg('sp3drem.xpm'), command=lambda * args:self.uiListCallback("rem", "uiTargetList"))
        self.uiTargetBtnClr = mc.symbolButton(w=60, h=18, ann='Clear the list', image=retimg('sp3dclr.xpm'), command=lambda * args:self.uiListCallback("clr", "uiTargetList"))
        ...
        self.uiPaintDupSCB = mc.symbolCheckBox(w=52, h=18, ann='Duplicate: Instance or Copy', ofi=retimg('sp3dduplicate.xpm'), oni=retimg('sp3dinstance.xpm'), changeCommand=lambda * args:self.uiCheckBoxCallback("instance", args))
        self.uiPaintRandSCB = mc.symbolCheckBox(w=52, h=18, ann='Object distribution: Random or Sequential', ofi=retimg('sp3dsequence.xpm'), oni=retimg('sp3drandom.xpm'), changeCommand=lambda * args:self.uiCheckBoxCallback("random", args))
        self.uiPaintAlignSCB = mc.symbolCheckBox(w=100, h=18, ann='Align generated objects to the target surface', ofi=retimg('sp3dalignoff.xpm'), oni=retimg('sp3dalign.xpm'), changeCommand=lambda * args:self.uiCheckBoxCallback("align", args))
        self.uiPaintCtxBtn = mc.symbolButton(w=105, h=28, ann='Paint', image=retimg('sp3dpaint.xpm'), command=lambda * args:self.genericContextCallback("PaintCtx"))
        self.uiPlaceCtxBtn = mc.symbolButton(w=105, h=28, ann='Place', image=retimg('sp3dplace.xpm'), command=lambda * args:self.genericContextCallback("PlaceCtx"))
